	...
	<div id="space_content">
		<section id="image_slider">
			<div class="image_wapper_container" id="image_container">
				...
				<div class="image_wrapper">
					<img src="images/room/room1_02.jpg" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room1_03.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room1_04.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room1_05.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room1_06.jpg" />
				</div>
			</div>
		...
		<section id="introduce">
			<div>
				<h1>자바 1</h1>
				<br />
				<p>북유럽 스타일의 모던하면서 정갈하게 꾸며진 room입니다.</p>
				<p>스파가 있는 욕실이 개방되어 세련된 디자인으로 멋진 여행을 꿈꾸는 분에게 권하고 싶은 객실입니다.</p>
				<br />
				<!--모바일 버전 반응형 추가 텍스트-->
				...
				<table class="introduce_table">
					...
					<tbody>
						<tr class="low_tr">
							<th rowspan="2">자바1</th>
							<th rowspan="2">오픈형/스파<br />월풀스파,침대1<br />욕실,주방
							</th>
							<th rowspan="2">56㎡</th>
							<th rowspan="2">2/2</th>
							<td>비수기</td>
		...
		<section id="service_mobile">
			...
			<div class="service_image_box">
				<a href="ServiceForm.do"> <img src="images/room/service1.png" />
					<p>개별 바베큐</p>
				</a> <a href="ServiceForm.do"> <img src="images/room/service2.png" />
					<p>조식</p>
				</a> <a href="ServiceForm.do"> <img src="images/room/service3.png" />
					<p>스파 입욕제</p>
				</a> <a href="ServiceForm.do"> <img src="images/room/service4.png" />
					<p>와인</p>
				</a>
			</div>
		</section>
