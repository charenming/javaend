	...
	<div id="space_content">
		<section id="image_slider">
			<div class="image_wapper_container" id="image_container">
				<div class="image_wrapper">
					<!--사진 자르기-->
					<img src="images/room/room3_01.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room3_02.jpg" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room3_03.jpg" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room3_04.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room3_05.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room3_06.png" />
				</div>
			</div>
		...
		<section id="introduce">
			<div>
				<h1>자바 3</h1>
				<br />
				<p>사랑하는 가족, 친구들과의 소중한 추억을 담을 수 있는 room입니다.</p>
				<p>침실로 들어오는 따스한 아침 햇살과 정겨운 바람이 여행의 여유로움을 더합니다.</p>
				<br />
				<!--모바일 버전 반응형 추가 텍스트-->
