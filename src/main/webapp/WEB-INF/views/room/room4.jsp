	...
	<div id="space_content">
		<section id="image_slider">
			<div class="image_wapper_container" id="image_container">
				<div class="image_wrapper">
					<img src="images/room/room4_01.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room4_02.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room4_03.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room4_04.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room4_05.png" />
				</div>
				<div class="image_wrapper">
					<img src="images/room/room4_06.png" />
				</div>
			</div>
		...
		<section id="introduce">
			<div>
				<h1>자바 5</h1>
				<br />
				<p>편안한 인테리어로 아름답고 소녀 감성이 물씬 풍기며 숲 속을 담고 있습니다.</p>
				<p>옛날 프랑스 동화에 나올 것만 같은 프렌치 스타일로 꾸며진 아름다운 객실입니다.</p>
				<br />
				<!--모바일 버전 반응형 추가 텍스트-->
